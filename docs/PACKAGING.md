# Packaging and metadata references

- [PortMaster packaging guide](https://portmaster.games/packaging.html)
- [PortMaster-New checker](https://github.com/PortsMaster/PortMaster-New/blob/main/tools/build_release.py)
- [Launcher example and MIT attribution](https://github.com/binarycounter/Westonpack/wiki/LibGDX-Example)
- [Game details and purchase page](https://www.gog.com/en/game/ashworld)
