...
Only org/portmaster/ashworld classes are written to ashworld-host.jar. All
com/orangepixel declarations and open-source dependencies are excluded. The player
supplies the unchanged supported ashworld.jar for the real runtime implementation.
